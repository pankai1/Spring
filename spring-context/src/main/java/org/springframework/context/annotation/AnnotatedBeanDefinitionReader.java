...
public class AnnotatedBeanDefinitionReader {
	...
	<T> void doRegisterBean(Class<T> beanClass, @Nullable Supplier<T> instanceSupplier, @Nullable String name,
		 ...
		 * AnnotatedGenericBeanDefinition包含一些元数据
		 * 比如 AnnotationMetadata  MethodMetadata
		 * */
		...
		* */
		...
		/*得到类的作用域
		* 通过scopeMetadataResolver中AnnotationConfigUtils工具
		* 从AnnotationMetadata中获取到AnnotationAttributes
		* 从AnnotationAttributes得到proxyMode*/
		...
		/*处理通用注解
		 * 通过abd得到元数据 例如LazyInit、Primary、DependsOn、Role、description，放入到abd中
		 * */
		...
		/*BeanDefinitionHolder是一个数据结构 可以理解为map key:beanName  value:abd */
		BeanDefinitionHolder definitionHolder = new BeanDefinitionHolder(abd, beanName);

		/*需要根据springMVC去理解*/
		definitionHolder = AnnotationConfigUtils.applyScopedProxyMode(scopeMetadata, definitionHolder, this.registry);

		/* BeanDefinitionRegistry作用是将beanDefinition放入到DefaultListableBeanFactory中的beanDefinitionMap集合容器中
		* beanName放入到beanDefinitionNames中去*/
